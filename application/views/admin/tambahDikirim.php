        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Tambah Data Pengiriman</h1>
                    <div class="row">
                        <div class="col-4">
                            <form action="<?php echo site_url('Admin/addPengiriman')?>" method="POST">
                                <div class="form-group mb-2">
                                    <label for="idpengiriman">ID Pengiriman</label>
                                    <input type="text" class="form-control" id="idpengiriman" name="idpengiriman" placeholder="Masukkan id pengiriman">
                                </div>
                                <div class="form-group mb-2">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <select class="custom-select w-50" id="status" name="status">
                                        ...
                                        <option value="diproses">Dikirim</option>
