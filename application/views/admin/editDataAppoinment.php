        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Edit Data Pembelian</h1>
                    <div class="row">
                        <div class="col-4">
                            <form action="<?php echo site_url('Admin/updatePembelian') ?>" method="POST">
                                 <div class="form-group mb-2">
                                    <label for="idtransaksi">ID Transaksi</label>
                                    <input type="text" class="form-control" id="idtransaksi" placeholder="Masukkan id transaksi" name="idtransaksi" readonly value="<?php echo $getAppointment[0]['id_transaksi'] ?>">
                                </div>
                                <div class="form-group mb-2">
                                ...
                                <input type="hidden" name="jmlLama" id="jmlLama" value="<?php echo $getAppointment[0]['jml_beli'] ?>">
                                <div class="form-group mb-2">
